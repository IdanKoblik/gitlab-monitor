...
@Component
public class TagEvent implements HookType {
    @Override
    public void process(ObjectNode objectNode, String instanceURL, Token token, TextChannel channel) {
        ...
        String userName = objectNode.get("user_name").asText();
        ...
        String projectName = objectNode.get("project").get("name").asText();
        ...
        if (after.equals("0000000000000000000000000000000000000000")) {
            channel.sendMessageEmbeds(
                    new EmbedBuilder()
                            .setTitle(String.format("Tag %s was deleted", target))
            ...
            channel.sendMessageEmbeds(
                    new EmbedBuilder()
                            .setTitle(String.format("Tag %s was created", target))
                            .setAuthor(userName, userLink, userAvatar)
                            .setDescription(sb.toString())
                            .setFooter(projectName)
                            .setTimestamp(Instant.now())
            ...
            channel.sendMessageEmbeds(
                    new EmbedBuilder()
                            .setTitle(String.format("Tag to %s", target))
                            .setAuthor(userName, userLink, userAvatar)
                            .setDescription(sb.toString())
                            .setFooter(projectName)
                            .setTimestamp(Instant.now())
